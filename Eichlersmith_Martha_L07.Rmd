...
#Using `cdc_small`construct a scatterplot of `weight` by `height`
#Color and shape should both identify `genhlth`
ggplot(cdc, aes(height, weight, color=genhlth, shape=genhlth))+
  # Minimal theme
  theme_minimal()+
  #Size of plotting characters should be 3.
  geom_point(size = 3)+
  ...
  #add white background to legend (alpha = 0.6) so can better read legend 
  theme(legend.background = element_rect(fill=alpha("white", 0.6), color="transparent"))+
