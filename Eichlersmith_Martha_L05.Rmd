...
```{r LO5-CH-plot1,  out.width="100%", fig.height=2.5, message = FALSE}
# ```{r LO5-CH-plot1,  out.width="100%", fig.height=2.5, message = FALSE}
...
```{r,  out.width="100%", fig.height=2.5, message=FALSE}
# ```{r,  out.width="100%", fig.height=2.5, message=FALSE}
options(tigris_use_cache = TRUE)
...
#can't get pivot_wider to work when geometry = false
